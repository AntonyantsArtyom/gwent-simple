...
const ALL_CARDS: CardType[] = [
  ...
  { id: "10", name: "Scout", power: 6, row: "ranged" },
  { id: "11", name: "Warrior", power: 10, row: "melee" },
  { id: "12", name: "Mage", power: 6, row: "ranged" },
  { id: "13", name: "Trebuchet", power: 6, row: "siege" },
  { id: "14", name: "Berserker", power: 4, row: "melee" },
